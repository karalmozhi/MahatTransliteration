namespace Client.Controllers
			{
				...
				//This code generated from Deliveries Powered by Mahat, Source Machine : 15.206.208.9 , Build Number : Build 14092021 #2021-09-014(Updated on 29102021 12:49) on 05/19/2023 09:17:00
			...
			public virtual async Task<IActionResult> Create_Alert_Templates(AlertTemplatesModel model, IFormCollection collection)
			{
			 ...
			 if(strReturnMessage.Replace("\"", "").Contains("201.1")){
			  ...
			  {
					var jsonObjAlertTemplates = await ApiClient.Get_ApiValues(getHttpClient(), "api/AlertTemplates/getById_AlertTemplates?AlertTemplatesid="+AlertTemplatesid+"&loginUserID="+HttpContext.Session.GetString("englishtotamilloginUserID"));
					if(jsonObjAlertTemplates.Length > 2)
					{
						...
						HttpContext.Session.SetSession("englishtotamilAlertTemplatesModel", model);
						return View(model);
					}
					else
					{
					...
					return RedirectToAction(redirectTo);
							...
							if (ModelState.IsValid)
							{
									...
									else
									{
                                        ...
                                        var modelCopy = HttpContext.Session.GetSession<AlertTemplatesModel> ("englishtotamilAlertTemplatesModel");
...
public virtual async Task<IActionResult> Remove_Alert_Templates(string AlertTemplatesid)
			{
				...
				try
				{
						message = await ApiClient.Get_ApiValues(getHttpClient(), "api/AlertTemplates/Remove_Alert_Templates?AlertTemplatesid="+AlertTemplatesid+"&loginUserID="+HttpContext.Session.GetString("englishtotamilloginUserID"));
...
,string entityaction
)
			{
				...
				return await ApiClient.Get_ApiValues(getHttpClient(), "api/AlertTemplates/Alert_Templates_List?entityname="+entityname+"&entityaction="+entityaction+"&loginUserID="+HttpContext.Session.GetString("englishtotamilloginUserID")
);
			}
